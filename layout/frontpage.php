 ...
 *
 * @package   theme_cleanhc
 * @copyright 2013 Moodle, moodle.org
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

// Get the HTML for the settings bits.
$html = theme_cleanhc_get_html_for_settings($OUTPUT, $PAGE);
...
<div id="page" class="container-fluid">
    ...
    <?php if (get_config('theme_clean', 'warningmsg')) { ?>
    <div class="row-fluid">
        <div class="alert alert-info warning span10 offset1">
                <h4>
                    <img src="<?php echo $CFG->wwwroot; ?>/theme/clean/pix/warning.png" alt="warning" />
                    <strong><?php echo get_config('theme_clean', 'warningmsg') ?></strong>
                </h4>
        </div>
    </div>
    <?php } ?>
    ...
    <div class="row-fluid cardscontainer">
        ...
        <div class="span2 card">
            <a href="<?php echo $CFG->wwwroot; ?>/local/tutoriais/politicas_de_uso.php">
                ...
                <p>Conheça o propósito deste ambiente e as responsabilidades dos usuários</p>
            </a>
        </div>

        <div class="span2 card">
            <a href="<?php echo $CFG->wwwroot; ?>/report/opencourses/index.php">
                <img src="<?php echo $CFG->wwwroot; ?>/theme/clean/pix/03.png" alt="01" />
                <h3>Cursos livres</h3>
                <p>Cursos de acesso livre a visitantes (apenas para visualização)</p>
            </a>
        </div>
